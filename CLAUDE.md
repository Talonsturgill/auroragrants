...
- Billing: Stripe (test mode first, live mode at week 4)
...
AuroraGrants helps Alaska nonprofits and tribal organizations manage post-award federal and foundation grant compliance reporting, with a free Deadline Radar tier, paid Solo and Team tiers for Anchorage 501(c)(3)s, and Institutional and Tribal Sovereignty tiers for ANCSA regional nonprofits and tribal governments. The v1 hero is post-award compliance reporting. Proposal drafting ships as v1.1 in month 3. Funder discovery ships as v2 in month 6.
...
1. Foundations (Next.js, Supabase, Clerk, Stripe scaffolds, marketing site shell, CI)
...
6. Tribal Sovereignty tier readiness (DPA wiring, ZDR routing, offline export/import, audit log, tenant export and delete)
...
- `/docs/03-sovereignty.md` — tribal data sovereignty requirements and the Sovereignty tier's contractual and architectural posture.
